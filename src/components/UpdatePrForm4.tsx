...
export const UpdatePrForm4: React.FC<UpdatePrForm4Props> = ({
  bYReview,
  aHReview,
  hTReview,
  setBYReview,
    ...
    <div>
      <label>
        ...
        <input
          type="checkbox"
          checked={bYReview}
          onChange={(e) => setBYReview(e.target.checked)}
        ></input>
      </label>
      <br />
      <label>
        ...
        <input
          type="checkbox"
          checked={aHReview}
          onChange={(e) => setAHReview(e.target.checked)}
        ></input>
      </label>
      <br />
      <label>
        ...
        <input
          type="checkbox"
          checked={hTReview}
          onChange={(e) => setHTReview(e.target.checked)}
        ></input>
      </label>
      <br />
    </div>
